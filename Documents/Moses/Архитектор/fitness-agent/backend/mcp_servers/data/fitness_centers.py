...
# Ключи — РУССКИЕ КОРНИ, чтобы матчить любые падежи: «йога»/«йогу»/«йоги»/«йогой» → «yoga».
ACTIVITY_ALIASES: dict[str, str] = {
    ...
    "теннис": "tennis",
    "tennis": "tennis",
    "йог": "yoga",  # йога, йогу, йоги, йогой
    "yoga": "yoga",
    "пилатес": "pilates",
    "pilates": "pilates",
    "зал": "gym",
    "тренажёрн": "gym",  # тренажёрный / тренажёрного / тренажёрном
    "тренажерн": "gym",  # тренажерный
    "gym": "gym",
    "тренировк": "gym",  # тренировка, тренировку, тренировки
    "единоборств": "martial_arts",  # единоборства, единоборств
    "бокс": "martial_arts",
    "мма": "martial_arts",
    "карат": "martial_arts",  # карате, каратэ
...
def normalize_activity(text: str) -> str | None:
    ...
    Работает по стеммам (русские корни) — 'йогу'/'йоги'/'йога' → 'yoga'.
    """
    t = text.lower()
